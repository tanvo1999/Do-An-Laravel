			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form action="{{ route('xl-dang-nhap') }}" method="POST" role="form">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Enter username">
						<input class="input100" type="text" id="username" name="ten_dang_nhap" placeholder="Tài khoản">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						<input class="input100" type="password" id="pass" name="mat_khau" placeholder="Mật khẩu">

    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <tbody>
                            @foreach($cauHoi as $CauHoi)
                                <tr>
                                    ...
                                    <td>{{ $CauHoi->dap_an }}</td>
                                    <td>
                                        <button onclick="Restore({{$CauHoi->id}})" type="button" class="btn btn-info waves-effect waves-light"><i class="mdi mdi-pen"></i></button>
            ...
            <script>
                ...
                function Restore($id){
                    Swal.fire({
                        title: 'Bạn có muốn phục hồi câu hỏi không?',
                        type: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',

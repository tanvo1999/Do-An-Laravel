                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <span class="pro-user-name ml-1">
                            {{ Session::get('ho_ten') }} <i class="mdi mdi-chevron-down"></i> 
                        </span>
                    </a>
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="{{ route('linh-vuc.thung-rac')}}">Thùng rác</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="{{ route('cau-hoi.thung-rac') }}">Thùng rác</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="{{ route('goi-credit.thung-rac') }}">Thùng rác</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <!-- <ul class="submenu">
                            ...
                            <li>
                                <a href="{{ route('nguoi-choi.thung-rac') }}">Thùng rác</a>
                            </li>
                        </ul> -->
                    </li>

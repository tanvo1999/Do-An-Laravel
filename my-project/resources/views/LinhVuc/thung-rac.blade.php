		...
		<div class="row">
            <div class="col-12">
                            ...
                            <tbody>
                                @foreach($linhVuc as $LinhVuc)
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="Restore({{$LinhVuc->id}})" type="button" class="btn btn-info waves-effect waves-light"><i class="mdi mdi-pen"></i></button>
                ...
                <script>
                    ...
                    function Restore($id){
                        Swal.fire({
                            title: 'Bạn có muốn phục hồi lĩnh vực không?',
                            type: 'warning',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',

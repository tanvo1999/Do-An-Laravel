    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <tbody>
                            @foreach($goiCredit as $GoiCredit)
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="Restore({{$GoiCredit->id}})" type="button" class="btn btn-info waves-effect waves-light"><i class="mdi mdi-pen"></i></button>
            ...
            <script>
                ...
                function Restore($id){
                    Swal.fire({
                        title: 'Bạn có muốn phục hồi gói credit không?',
                        type: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
